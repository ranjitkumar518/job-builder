...
if [ $env == DEV ]; then
   ...
   if [ $jobtype == Gsf ]; then
      ...
      sudo cp variables.yaml $user_home/GSF_DEV/variables.yaml
      ...
      sudo cp variables.yaml $user_home/NONGSF_DEV/
