...
if [ $env == DEV ]; then
   ...
   if [ $jobtype == Gsf ]; then
      ...
      cp variables.yaml $user_home/GSF_DEV/variables.yaml
      ...
      cp variables.yaml $user_home/NONGSF_DEV/
